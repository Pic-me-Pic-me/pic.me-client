  ...
  return (
    <>
      ...
      <StShareWrapper>
        ...
        <StShareInfo>
          <input type="text" defaultValue={`https://with-picme.com/vote/common/pictures/${voteId}`} readOnly />
          <CopyToClipboard text={`https://with-picme.com/vote/common/pictures/${voteId}`}>
